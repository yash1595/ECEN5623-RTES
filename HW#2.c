/****************************************************************
* Example taken from Sam Seiwart's course RTES ECEN-5623.
* Code has been modified for including 5 additional test cases.
*
****************************************************************/
...
U32_T ex5_period[] = {2, 5, 10};    //EX5
U32_T ex5_wcet[] = {1, 2, 1};

U32_T ex6_period[] = {3, 5, 15};    //EX7
U32_T ex6_wcet[] = {1, 2, 4};

U32_T ex7_period[] = {6, 8, 12,24}; //EX8
U32_T ex7_wcet[] = {1, 2, 4, 6};

U32_T ex8_period[] = {2, 5, 7, 14}; //EX9
U32_T ex8_wcet[] = {1, 1, 1, 2};

U32_T ex9_period[] = {3, 6, 9};     //EX10
U32_T ex9_wcet[] = {1, 2, 3};
...
{ 
 ...
 //////////////////////////////////////////////////////////////////////////////////       
  ...
  numServices = sizeof(ex5_period)/sizeof(U32_T);
    ...
    printf("Ex-6 U=%4.2f (C1=1, C2=2, C3=4; T1=3, T2=5, T3=15; T=D): ",
       ((1.0/3.0) + (3.0/5.0) + (4.0/15.0)));
  numServices = sizeof(ex6_period)/sizeof(U32_T);
    ...
    printf("Ex-7 U=%4.2f (C1=1, C2=2, C3=4, C4=6; T1=6, T2=8, T3=12, T4=24; T=D): ",
  ...
  numServices = sizeof(ex7_period)/sizeof(U32_T);
    if(completion_time_feasibility(numServices, ex7_period, ex7_wcet, ex7_period) == TRUE)
        ...
        printf("INFEASIBLE\n");
    // Remaining
    printf("Ex-8 U=%4.2f (C1=1, C2=1, C3=1, C4=2; T1=2, T2=5, T3=7,T4=14; T=D): ",
       ((1.0/2.0) + (1.0/5.0) + (1.0/7.0) + (2.0/14.0)));
  numServices = sizeof(ex8_period)/sizeof(U32_T);
    ...
    printf("Ex-9 U=%4.2f (C1=1, C2=2, C3=3; T1=3, T2=6, T3=9; T=D): ",
